...
import amigao from '../assets/img/history/amigao.jpg';
    ...
    return (
        <div className="w-full h-auto flex flex-col items-center justify-center py-10">
            <div className="w-11/12 lg:w-4/5 h-auto flex flex-col lg:flex-row justify-start items-center mb-10">
                <h1 className="font-sans text-red-dark font-bold text-3xl lg:text-4xl">Conheça o Amigão</h1>
            </div>
            <div className="bg-red-dark w-11/12 lg:w-4/5 h-auto flex flex-col lg:flex-row items-center justify-center rounded-xl">
